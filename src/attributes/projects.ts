...
import wwWebsite from "../assets/images/projects/woven-and-woods.png";
import wwFlooringOutlet from "../assets/images/projects/ww-flooring-outlet.png";
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    meta: "Astro / Starlight / Technical documentation",
    description:
      "Internal knowledge base built with Astro and Starlight, using Decap CMS and Netlify authentication so the Woven & Woods team can manage documentation without developer involvement.",
    link: "#contact",
    linkText: "Contact me for more details",
